...
## RSC Boundaries
Detect invalid React Server Component patterns. See `rsc-boundaries.md` for:
- Async client component detection (invalid)
- Non-serializable props detection
- Server Action exceptions

## Async Patterns
Next.js 15+ async API changes. See `async-patterns.md` for:
...
- Rebuild specific routes with `--debug-build-paths` check
